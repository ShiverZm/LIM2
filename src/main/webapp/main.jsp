	...
	<div region="west" style="width: 200px" title="导航菜单" split="true">
		<div class="easyui-accordion" data-options="fit:true,border:false">
			<div title="预约使用" data-options="selected:true,iconCls:'icon-yxgl'"
				style="padding: 10px">
				<a
					href="javascript:openTab('预约使用','laboratoryReserList.jsp','icon-yxjhgl')"
...
<shiro:hasPermission name="manage:*">
			<div title="信息管理" data-options="iconCls:'icon-fwgl'"
				...
				<a href="javascript:openTab('实验室预约列表','laboratoryReserManager.jsp','icon-khgxfx')"
					class="easyui-linkbutton"
...
<shiro:hasRole name="admin">
			<div title="权限管理" data-options="iconCls:'icon-jcsjgl'"
				style="padding:10px">
				<a href="javascript:openTab('用户信息管理','userManager.jsp','icon-user')"
					class="easyui-linkbutton"
	...
	<div id="dlg" class="easyui-dialog"  style="width:620px;height:250px;padding: 10px 20px"
	 closed="true">
	  <form id="fm"	method="post" action="${pageContext.request.contextPath}/user/modifyPassword.do">
	   <table cellspace="8px">
	     <tr>
	       <td>账号：</td>
	       <td><input type="text" id="userName" name="userName" class="easyui-validatabox" required="true" readonly="true" value="${currentUser.userName}"/>&nbsp;<font color="red">*</font></td>
	     </tr>
	     <tr>
	       <td>旧密码：</td>
	       <td><input type="text" id="oldPassword1" name="oldPassword1" class="easyui-validatabox" required="true"/>&nbsp;<font color="red">*</font></td>
	     </tr>
	      <tr>
	       <td>确认旧密码：</td>
	       <td><input type="text" id="oldPassword2" name="oldPassword2" class="easyui-validatabox" required="true" onblur="validata()"/>&nbsp;<font color="red">*</font></td>
	     </tr>
	     <tr>
	       <td>新密码：</td>
	       <td><input type="text" id="newPassword" name="newPassword" class="easyui-validatabox" required="true"/>&nbsp;<font color="red">*</font></td>
	     </tr>
	     <tr>
	          <td></td> 
